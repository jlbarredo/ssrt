...
matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(4).duration = tmp(:,3);
...
matlabbatch{1}.spm.stats.fmri_spec.sess(2).cond(1).duration = tmp(:,2);
...
matlabbatch{1}.spm.stats.fmri_spec.sess(2).cond(2).duration = tmp(:,2);
...
matlabbatch{1}.spm.stats.fmri_spec.sess(2).cond(3).duration = tmp(:,2);
...
matlabbatch{1}.spm.stats.fmri_spec.sess(2).cond(4).duration = tmp(:,2);
...
matlabbatch{3}.spm.stats.con.consess{15}.tcon.name = 'POST>PRE StopInh-StopResp';
matlabbatch{3}.spm.stats.con.consess{15}.tcon.weights = [0,-1,1,err1,drift,CSF,motion,0,1,-1,err2,drift,CSF,motion,numsess];
matlabbatch{3}.spm.stats.con.consess{15}.tcon.sessrep = 'none';
